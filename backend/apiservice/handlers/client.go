...
// 	_, err := database.DB.Exec("INSERT INTO affiliators (affiliator_fname, affiliator_lname, affiliator_email, affiliator_phone, affiliator_website, api_key) VALUES ($1, $2, $3, $4, $5, $6)", client.AffiliatorFirstName, client.AffiliatorLastName, client.AffiliatorEmail, client.AffiliatorPhone, client.AffiliatorWebsite, client.APIKey)
// 	if err != nil {
...
`
    ...
    // แปลง string ของหลายๆ website ให้เป็น []string
...
func GetAffiliatorByEmail(c *gin.Context) {
    ...
    // ดึงเว็บไซต์จาก referrer_websites
